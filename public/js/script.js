...
const arrayOfPossibleMessages = [
    ...
    {message: "pastafrola", response: "La pastaflora entera cuesta $8500. Y la individual cuesta $2000"},
    {message: "pasta frola", response: "La pastaflora entera cuesta $8500. Y la individual cuesta $2000"},
    {message: "pastaflora", response: "La pastaflora entera cuesta $8500. Y la individual cuesta $2000"},
    {message: "precio de la pastafrola", response: "La pastaflora entera cuesta $8500. Y la individual cuesta $2000"},
    {message: "cuesta la pastafrola", response: "La pastaflora entera cuesta $8500. Y la individual cuesta $2000"},
    {message: "precio de la pasta frola", response: "La pastaflora entera cuesta $8500. Y la individual cuesta $2000"},
    {message: "cuesta la pasta frola", response: "La pastaflora entera cuesta $8500. Y la individual cuesta $2000"},
    {message: "precio de la pastafrola", response: "La pastaflora entera cuesta $8500. Y la individual cuesta $2000"},
    {message: "cuesta la pastafrola", response: "La pastaflora entera cuesta $8500. Y la individual cuesta $2000"},
